...
const SettingsPage = () => {
  ...
  const handleLogout = () => {
    ...
    setTimeout(() => {
      setIsLoading(false); // Hide the loading screen just before navigating
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-6">
      <div className="bg-white shadow-xl rounded-xl w-full max-w-md overflow-hidden">
        {/* Header */}
        <header className="bg-orange-500 text-white text-center py-5">
          <h1 className="text-2xl font-semibold pb-9">Account Settings</h1>
        </header>
        <br />
        ...
        <div className="flex justify-center relative -mt-12">
          ...
          <button className="absolute bottom-0 right-2 bg-orange-500 p-2 rounded-full text-white shadow-lg">
            <svg
        ...
        <div className="p-6">
          ...
          <div className="mt-6">
            ...
            <ul className="space-y-4">
              {[
                { name: 'Briley Henderson', sub: 'Profile Settings', action: 'Edit' },
